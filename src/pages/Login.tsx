...
import { z } from 'zod';
import { Eye, EyeOff, Loader2, AlertCircle, X, KeyRound } from 'lucide-react';
...
export default function Login() {
  ...
  return (
    ...
    >
      {/* LEFT PANEL: Illustration (Fills 45% of viewport width) */}
      <div
      ...
      {/* RIGHT PANEL: Form (Fills remaining 55% of viewport width) */}
      <div
      ...
      >
        ...
        <form
          ...
          noValidate
          style={{ display: 'flex', flexDirection: 'column', gap: '20px', maxWidth: '440px', width: '100%' }}
        >
          {/* User ID */}
      ...
      {showForgotModal && (
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: '13px', lineHeight: '1.6', color: '#64748b', margin: '0 0 24px' }}>
              Contact your administrator for credentials reset.
            </p>
            <button
              onClick={() => setShowForgotModal(false)}
              style={{
